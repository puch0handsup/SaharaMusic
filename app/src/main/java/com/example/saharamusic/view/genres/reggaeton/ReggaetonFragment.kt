package com.example.saharamusic.view.genres.reggaeton
...
class ReggaetonFragment : BaseFragment() {
    ...
    val genresAdapter by lazy {
        GenresAdapter {
            ...
            findNavController().navigate(R.id.action_reggaeton_fragment_to_exo_player_fragment)
        }
    }
    ...
    override fun onCreateView(
        ...
        saharaViewModel.reggaetonSongs.observe(viewLifecycleOwner) { state ->
            when(state){
                is UIState.LOADING -> {}
